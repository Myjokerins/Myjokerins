...
![Data Quality Tab in the Table Page](<../../.gitbook/assets/image (5) (1).png>)
...
![Add Column Test](<../../docs/.gitbook/assets/image (52) (2) (1).png>)
...
![Freshly created tests](<../../.gitbook/assets/image (278).png>)
...
In the [connectors](../../integrations/connectors/) documentation for each source, we showcase how to run the Profiler Workflow using the Airflow SDK or the `metadata` CLI. When configuring the JSON configuration for the workflow, we can add tests as well.
...
To learn how to prepare and run the Profiler Workflow for a given source, you can take a look at the documentation for that specific [connector](../../integrations/connectors/).
