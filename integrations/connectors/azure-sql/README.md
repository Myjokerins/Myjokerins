...
{% content-ref url="run-azuresql-connector-with-the-airflow-sdk.md" %}
[run-azuresql-connector-with-the-airflow-sdk.md](run-azuresql-connector-with-the-airflow-sdk.md)
{% endcontent-ref %}

{% content-ref url="run-azuresql-connector-with-the-cli.md" %}
[run-azuresql-connector-with-the-cli.md](run-azuresql-connector-with-the-cli.md)
{% endcontent-ref %}
